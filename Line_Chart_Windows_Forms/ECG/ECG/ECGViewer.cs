...
namespace ECG
{
	...
	public class ECGViewer : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.menuOpenFile.Text = "Connect ...";
            ...
            this.menuItem2.Text = "Alert";
            this.menuItem2.Click += new System.EventHandler(this.menuItem2_Click);
            // 
            // menuItem4
            // 
            this.menuItem4.Index = 6;
            this.menuItem4.Text = "Abnormal Data";
            ...
            this.labelPatient.Location = new System.Drawing.Point(463, 122);
		...
		private void ECGViewer_Load(object sender, System.EventArgs e)
		{
            ...
            int rand = rnd.Next (70,80);
            label1.Text = "Heart Rate :"+rand.ToString();
		}
		...
		private void menuOpenFile_Click(object sender, System.EventArgs e)
		{
			try
			{
                ...
                string filename = Application.StartupPath +"\\Data.scp";
                ...
                if (File.Exists(filename) )
				{
					...
					else
					{
						...
						format = _ECGReader.Read(filename);
					}
        ...
        private void menuItem3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Abnormal Report Please Reffer to Doctor");
